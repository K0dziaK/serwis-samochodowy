...
**Oczekiwany rezultat:** Po wznowieniu klienci są wyrzuceni jednorazowo (komunikat "Wybiła godzina 18:00. Zamykam przyjmowanie klientów" pojawia się raz). Flaga `clients_dismissed_today` zapobiega wielokrotnemu wyrzucaniu ([role_service.c#L60-L79](role_service.c#L60)).  
**Status:** ✅
